...
extension CommentReactionX on CommentReaction {
  String get emoji {
    switch (this) {
      case CommentReaction.like:
        return '👍';
      case CommentReaction.love:
        return '❤️';
      case CommentReaction.laugh:
        return '😂';
      case CommentReaction.sad:
        return '😢';
      case CommentReaction.angry:
        return '😡';
      case CommentReaction.wow:
        return '😮';
    }
  }
